...
contract ScrollPaymentBridge {
    ...
    function depositETHToScroll(address scrollBrige, uint256 amount ,uint gasLimit) public payable {
        IL1ETHGateway(scrollBrige).depositETH(msg.sender, amount, gasLimit);
    }
}
